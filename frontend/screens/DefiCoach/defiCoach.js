...
import { DefiForm } from "../../components/Defi/defiForm";

export default function DefiCoach() {
...
function Basic() {
  ...
  function addRow(fullname, timeStamp, recentText, avatarUrl) {
    setListData([
      ...listData,
      { id: listData.length + 1, fullname, timeStamp, recentText, avatarUrl },
    ]);
  }
