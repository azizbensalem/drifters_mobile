...
const API_URL = "http://192.168.0.46:8080/api/coach/defi/";
const API_URL_Player = "http://192.168.0.46:8080/api/joueur/defi/";
...
const checkDone = async (id) => {
  ...
  const result = await axios.get(
    `http://127.0.0.1:8080/api/joueur/checkdone/${id}/${token}`
  );
  return result.data;
};
